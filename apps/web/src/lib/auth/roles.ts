...
export const ROLE_NAV_GROUPS: Record<UserRole, string[]> = {
  super_admin: ["dashboard", "academic", "transport", "hostel", "mess", "staff_hr", "finance", "inventory", "admission", "communication"],
  admin: ["dashboard", "academic", "transport", "hostel", "mess", "staff_hr", "finance", "inventory", "admission", "communication"],
