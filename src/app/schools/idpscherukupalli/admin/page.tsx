...
export default function AdminDashboardPage() {
 ...
 <Link href="/schools/${schoolId}/admin/hr/leaves" className="w-full mt-4 h-10 inline-flex items-center justify-center rounded-lg bg-gray-900 text-white font-bold text-xs hover:bg-gray-800 transition-colors shadow-lg shadow-gray-900/20">
