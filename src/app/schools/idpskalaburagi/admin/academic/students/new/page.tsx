...
const Input = ({ label, type = "text", value, onChange, placeholder, required, disabled = false, tooltip }: any) => (
 ...
 className="w-full h-8 rounded-lg border border-gray-200 bg-gray-50/50 px-2.5 text-[12px] font-semibold text-gray-900 focus:bg-white focus:border-[#144835] focus:ring-2 focus:ring-[#144835]/10 outline-none transition-all shadow-sm disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed placeholder:text-gray-400"
 />
 </div>
);
...
const Select = ({ label, value, onChange, options, required, disabled = false, tooltip }: any) => (
 ...
 onChange={onChange}
 disabled={disabled}
 className="w-full h-8 rounded-lg border border-gray-200 bg-gray-50/50 px-2.5 py-0 text-[12px] font-semibold text-gray-900 focus:bg-white focus:border-[#144835] focus:ring-2 focus:ring-[#144835]/10 outline-none transition-all shadow-sm disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed appearance-none"
...
export default function AdminAddStudentPage() {
 ...
 <h1 className="text-lg sm:text-xl font-black bg-gradient-to-r from-[#144835] to-emerald-600 bg-clip-text text-transparent tracking-tight">Add New Student</h1>
 </div>
 ...
 >
 <Save size={16} />
 <span>{saving ? "Saving Data..." : "Submit Registration"}</span>
 </button>
 )}
 </div>
