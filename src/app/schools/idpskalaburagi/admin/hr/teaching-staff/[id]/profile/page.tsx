...
export default function AdminTeachingStaffProfilePage({
 ...
 <div>
 <h1 className="text-xl font-black tracking-tight text-[#1A1A1A]">Teaching Staff Profile</h1>
 <p className="mt-2 text-xs font-semibold text-slate-600">Staff not found: {employeeId}</p>
 </div>
 <Link
 href="/idpskalaburagi/hr/teaching-staff"
 ...
 <EmployeeProfileView
 employee={employee}
 editHref={`/idpskalaburagi/hr/teaching-staff/${encodeURIComponent(employee.id)}/edit`}
 backHref="/idpskalaburagi/hr/teaching-staff"
