                ...
                {[
                    ...
                    return (
                        <div key={step.id} className="flex flex-col items-center group cursor-pointer w-[25%]" onClick={() => isCompleted && setCurrentStep(step.id)}>
                            <div className={`w-8 sm:w-10 h-8 sm:h-10 mx-auto rounded-xl flex items-center justify-center text-xs font-bold border-2 transition-all duration-500 bg-white ${isCompleted
