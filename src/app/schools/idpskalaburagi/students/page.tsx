...
import { useBranch } from "@/components/students/BranchContext";
...
export default function AdminDashboardPage() {
 ...
 let currentEvents: Array<{ id: string; title: string; date: string; type: EventType; location?: string }> = [];
 let currentHolidays: Array<{ id: string; title: string; date: string; type: EventType; location?: string }> = [];
