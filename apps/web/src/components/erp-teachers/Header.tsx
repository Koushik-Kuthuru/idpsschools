...
export default function Header({ setIsMobileMenuOpen }: HeaderProps) {
  ...
  const profileHref = `/schools/${schoolId}/teachers/profile`;
  ...
  const userDesignation = role === "teacher" ? "Teacher" : role ? role.charAt(0).toUpperCase() + role.slice(1) : "Staff";
          ...
          >
            ...
            <div className="border-t border-gray-100 px-4 py-3 bg-gray-50/40">
              <button
                ...
                onClick={() => {
                  setNotificationsOpen(false);
                  router.push(`/schools/${schoolId}/teachers/notifications`);
                }}
