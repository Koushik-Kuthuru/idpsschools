  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto p-4 md:p-8 animate-in fade-in duration-500 font-jost space-y-4">
      ...
      <div className="bg-white rounded-[16px] border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-4 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          <h2 className="text-xl sm:text-2xl font-black text-gray-900 tracking-tight uppercase">Class Timetable</h2>
      ...
      <div className="bg-gradient-to-r from-[#144835] to-[#0f3628] text-white p-6 rounded-[16px] flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10">
          <span className="bg-[#a2c144]/20 text-[#a2c144] border border-[#a2c144]/10 px-3 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider">
            Happening Now
          </span>
          <h3 className="text-xl md:text-2xl font-black uppercase tracking-wide mt-2">Mathematics Session</h3>
            ...
            return (
              ...
              >
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-[#144835] uppercase tracking-widest">Period {period.num}</span>
                  <span className="text-[11px] text-gray-400 font-bold uppercase mt-0.5">{period.time}</span>
                </div>
                
                <div className="pl-4 md:pl-8 border-l border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    <p className={`text-sm font-black uppercase tracking-wide ${isLunch ? "text-amber-800" : "text-[#144835]"}`}>
                      {slot.subject}
                    </p>
                  ...
                  {!isLunch && (
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-xs font-black text-gray-800">{slot.teacher}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white border border-gray-100 p-6 rounded-[16px] shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
          <h3 className="text-xs font-black text-[#144835] uppercase tracking-wider mb-4 border-l-4 border-[#144835] pl-2">Professor Announcements</h3>
        ...
        <div className="bg-white border border-gray-100 p-6 rounded-[16px] shadow-[0_2px_10px_rgba(0,0,0,0.04)]">
          <h3 className="text-xs font-black text-[#144835] uppercase tracking-wider mb-4 border-l-4 border-[#144835] pl-2">Upcoming Homework Deadlines</h3>
          <div className="divide-y divide-gray-100">
            <div className="py-2.5 flex justify-between items-center text-xs">
              ...
              <span className="font-black text-red-600 bg-red-50 px-2 py-0.5 rounded text-[10px] uppercase">Due Tomorrow</span>
            </div>
            <div className="py-2.5 flex justify-between items-center text-xs">
              <span className="font-extrabold text-gray-700">Computer Science Project Draft</span>
              <span className="font-black text-amber-800 bg-amber-50 px-2 py-0.5 rounded text-[10px] uppercase">Due in 3 Days</span>
            </div>
            <div className="py-2.5 flex justify-between items-center text-xs">
              <span className="font-extrabold text-gray-700">English Book Review</span>
              <span className="font-black text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded text-[10px] uppercase">Due Oct 24</span>
            </div>
          </div>
        </div>
      </div>
