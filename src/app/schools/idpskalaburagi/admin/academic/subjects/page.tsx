...
export default function AdminSubjectsPage() {
 ...
 <Link href={`/idpskalaburagi/academic/subjects/${encodeURIComponent(s.id)}`} className="h-7 inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-3 text-[10px] font-bold text-gray-700 shadow-sm hover:bg-gray-50 transition-colors ">
 View
 </Link>
 </td>
 </tr>
