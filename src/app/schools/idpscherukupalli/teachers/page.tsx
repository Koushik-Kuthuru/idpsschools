...
export default function AdminDashboard() {
 ...
 <p className="mt-1 text-lg text-slate-600">Central School (New York)</p>
 </div>
 ...
 <Link href="/schools/${schoolId}/admin/approvals" className="text-xs font-bold text-primary hover:underline">View All</Link>
 </div>
 <div className="p-4 flex-1">
