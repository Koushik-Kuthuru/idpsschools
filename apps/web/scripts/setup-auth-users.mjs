...
const users = [
  ...
  {
    email: "finance@idpscherukupalli.com",
    password: "Admin@1234",
    displayName: "Finance Team – Cherukupalli",
    role: "accountant",
    schoolId: "idpscherukupalli",
  },
  {
    email: "hr@idpscherukupalli.com",
    password: "Admin@1234",
    displayName: "HR Manager – Cherukupalli",
    role: "hr_manager",
    schoolId: "idpscherukupalli",
  },
  {
    email: "reception@idpscherukupalli.com",
    password: "Admin@1234",
    displayName: "Receptionist – Cherukupalli",
    role: "receptionist",
    schoolId: "idpscherukupalli",
  },
  {
    email: "tech@idpscherukupalli.com",
    password: "Admin@1234",
    displayName: "Tech Team – Cherukupalli",
    role: "tech_team",
    schoolId: "idpscherukupalli",
  },
];
...
Test credentials (all passwords: Admin@1234):
  ...
  finance@idpscherukupalli.com  → accountant (Cherukupalli)
  hr@idpscherukupalli.com         → hr_manager (Cherukupalli)
  reception@idpscherukupalli.com  → receptionist (Cherukupalli)
  tech@idpscherukupalli.com       → tech_team (Cherukupalli)
`);
  process.exit(0);
}
