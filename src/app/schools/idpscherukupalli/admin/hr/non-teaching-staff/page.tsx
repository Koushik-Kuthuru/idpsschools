...
export default function AdminNonTeachingStaffPage() {
 ...
 <div>
 <p className="text-xs font-bold text-gray-500">Total Staff</p>
 ...
 <div>
 <p className="text-xs font-bold text-gray-500">On Leave</p>
 <div className="flex items-baseline gap-2">
 ...
 className="w-full h-9 appearance-none bg-gray-50/50 border border-gray-200 rounded-lg pl-9 pr-8 text-xs font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#144835]/20 focus:border-[#144835] focus:bg-white cursor-pointer hover:bg-gray-50 transition-colors shadow-sm"
 >
 ...
 <div className="text-xs font-bold text-gray-500">{loading ? "Loading..." : `${filtered.length} members`}</div>
 </div>
